...
exports.updateOfertas = exports.postOfertas = exports.getPorId = exports.getPeladas = exports.getOfertasPorIdEmpresa = exports.getConFiltros = exports.deleteOferta = void 0;
...
const getPeladas = async (req, res) => {
  let pagina = 0;
  let limite = 1000;
  models.ofertas.findAndCountAll({
    limit: limite,
...
const postOfertas = async (req, res) => {
  ...
  }).then(ofertas => res.status(201).send({
    id: ofertas.id
  })).catch(error => {
...
exports.postOfertas = postOfertas;

const deleteOferta = async (req, res) => {
  const onSuccess = ofertas => ofertas.destroy().then(() => res.sendStatus(200)).catch(() => res.sendStatus(500));
...
const updateOfertas = async (req, res) => {
  const onSuccess = ofertas => ofertas.update({
    fk_id_jornada: req.body.idJornada,
    fk_id_contrato: req.body.idContrato,
    fk_id_estudio: req.body.idEstudio,
    fk_id_carrera: req.body.idCarrera,
...
exports.updateOfertas = updateOfertas;
