...
router.delete('/cuit/:id', _validador.validateToken, (0, _utils.withErrorHandling)(_empresas.deleteEmpresa));
router.post('/', (0, _utils.withErrorHandling)(_empresas.postEmpresa));
router.put('/cuit/:id', _validador.validateToken, (0, _utils.withErrorHandling)(_empresas.updateEmpresa));
