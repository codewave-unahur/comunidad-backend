...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.addColumn(
      ...
      'fk_id_tipo_documento', 
      {
        ...
        //allowNull: false,
      references: {
        model: 'tipos_documentos', // Nombre de la tabla que se referencia (en minúsculas y en plural)
  ...
  down: async (queryInterface, Sequelize) => {
    await queryInterface.removeColumn('postulantes', 'fk_id_tipo_documento');
  }
};
