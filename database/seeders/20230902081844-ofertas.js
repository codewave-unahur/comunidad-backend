    ...
    const ofertas = [
      {
        ...
        descripcion:
          'El puesto de Laboratorista requiere de una persona responsable, prolija y activa. Requisito excluyente: título "técnico químico" o conocimientos relacionados. Sus tareas serán...',
        edad_desde: 22,
        edad_hasta: 23,
      ...
      },
      {
        ...
        descripcion:
          "Telefónica se encuentra en la búsqueda de estudiantes o recién graduados de ARQUITECTURA/INGENIERÍA o carreras afines para DISEÑO DE REDES FIBRA ÓPTICA. Requisitos: Estudiante universitario de Arquitectura o Ingeniería. Manejo de AUTOCAD avanzado. Idioma: Inglés. Disponibilidad Full Time.",
        edad_desde: 23,
        edad_hasta: 33,
      ...
      },
      {
        ...
        descripcion:
          "Nos encontramos en búsqueda de un Jefe de mantenimiento eléctrico, para sumarse a nuestro equipo. Será tu objetivo garantizar el buen funcionamiento eléctrico / electrónico de la planta. ¿Qué desafíos te esperan? 1.Liderar y capacitar al equipo de mantenimiento eléctrico...",
        edad_desde: 24,
        edad_hasta: 24,
      ...
      },
      {
        ...
        descripcion:
          "Somos una empresa en crecimiento constante y estamos ampliando nuestro equipo de trabajo. Buscamos profesionales que tengan muchas ganas de aprender nuevas tecnologías...",
        edad_desde: 20,
        edad_hasta: 23,
        experiencia_previa_desc: "Sin experiencia",
        zona_trabajo: "CABA",
        ...
        otros_detalles:
          "Requisitos mínimos: Conocimiento general sobre las redes y servicios de proveedores de CATV e Internet...",
        beneficios: "Varios",
      ...
      },
      {
        ...
        descripcion:
          "Seleccionaremos Supervisor de Laboratorio. Perfil: Nivel de Educación Técnico químico o similar. Experiencia Previa Técnico de laboratorio 4 años...",
        edad_desde: 30,
        edad_hasta: 35,
      ...
      },
      {
        ...
        descripcion:
          "Buscamos perfiles de Soporte Técnico de Laboratorio para formar parte de nuestro equipo. Los principales desafíos del puesto son: Instalación y configuración de sistemas operativos (Windows)...",
        edad_desde: 24,
        edad_hasta: 30,
        experiencia_previa_desc: "No necesita experiencia previa",
      ...
      },
      {
        ...
        descripcion:
          "Nos encontramos en búsqueda de un Analista de control de calidad físico químico para formar parte de nuestro staff. Serán sus funciones principales: Análisis de producto terminado y semielaborado según técnicas analíticas y Farmacopeas...",
        edad_desde: 20,
        edad_hasta: 31,
        experiencia_previa_desc: "No necesita experiencia previa",
      ...
      },
      {
        ...
        descripcion:
          "Importante industria alimenticia se encuentra en la búsqueda de un Analista de Laboratorio. Sus principales tareas serán: Cumplimiento de Instructivos de trabajo del área...",
        edad_desde: 20,
        edad_hasta: 22,
        experiencia_previa_desc: "No necesita experiencia previa",
        zona_trabajo: "Merlo",
